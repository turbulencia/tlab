...
!########################################################################
SUBROUTINE CAVG1V3D(ilim, nx,ny,nz, umin_ext,umax_ext,u, a, nbins,pdf,avg, wrk1d)
...
!########################################################################
SUBROUTINE CAVG1V3D1G(ilim, nx,ny,nz, igate,gate, umin_ext,umax_ext,u, a, nbins,pdf,avg, wrk1d)
