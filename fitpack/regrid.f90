...
!  ..scalar arguments..
      TREAL xb,xe,yb,ye,s,fp
      TINTEGER iopt,mx,my,kx,ky,nxest,nyest,nx,ny,lwrk,kwrk,ier
!  ..array arguments..
      TREAL x(mx),y(my),z(mx*my),tx(nxest),ty(nyest),&
       c((nxest-kx-1)*(nyest-ky-1)),wrk(lwrk)
      TINTEGER iwrk(kwrk)
!  ..local scalars..
      TREAL tol
      TINTEGER i,j,jwrk,kndx,kndy,knrx,knry,kwest,kx1,kx2,ky1,ky2,&
