...
\tt TermRotation    & \tt None, CoriolisExplicit, CoriolisNormalized, ForceRotation & Formulation of Rotation terms.\\
...
\tt Parameters & {\em value1, value2, ...} & Parameters that define the rotation term.\\
\end{longtable}
