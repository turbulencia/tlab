...
Let us consider first a gas with one single species. The evolution equation for the energy is written in terms of the specific internal energy (sensible plus formation). Viscosity, thermal conductivity, diffusivity and the specific heat ratio can depend on the temperature. We consider the ideal gas law. The governing equations are written as follows:
\begin{subequations}
  \begin{align}
