...
\begin{equation}
  \partial_3\,p_\mathrm{bg}=\mathbf{H}^{-1}\, g_3\,\rho_\mathrm{bg}\;,\qquad p_\mathrm{bg}(x_3=x_{3,0})=p_{\mathrm{bg},0}\;,
\end{equation}
where 
\begin{equation}
...
\begin{equation}
  \zeta_1 = h + \frac{\gamma_0-1}{\gamma_0}\mathbf{H}^{-1}(x_3-x_{3,0}) \;.
\end{equation}
