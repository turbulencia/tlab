...
\begin{subequations}
  \begin{align}
    ...
    \end{align}
\end{subequations}
Thus, the algorithm can be expressed formally as a matrix multiplication, the diagonals being calculated once in the initialization step and being stored in the filter-structure data.
