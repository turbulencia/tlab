...
! -------------------------------------------------------------------
    ...
    if (ims_npro_i > 1) then
        ...
        call TLAB_MPI_TRPF_I(q(1, 1), wrk3d, ims_ds_i(1, id), ims_dr_i(1, id), ims_ts_i(1, id), ims_tr_i(1, id))
        call TLAB_MPI_TRPB_I(wrk3d, q(1, 2), ims_ds_i(1, id), ims_dr_i(1, id), ims_ts_i(1, id), ims_tr_i(1, id))
...
! -------------------------------------------------------------------
    ...
    if (ims_npro_k > 1) then
        ...
        call TLAB_MPI_TRPF_K(q(1, 1), wrk3d, ims_ds_k(1, id), ims_dr_k(1, id), ims_ts_k(1, id), ims_tr_k(1, id))
        itime = idummy
        call TLAB_MPI_TRPB_K(wrk3d, q(1, 2), ims_ds_k(1, id), ims_dr_k(1, id), ims_ts_k(1, id), ims_tr_k(1, id))
        call SYSTEM_CLOCK(t_end, PROC_CYCLES, MAX_CYCLES)
