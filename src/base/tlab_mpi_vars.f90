...
module TLabMPI_VARS
    ...
    integer, public :: ims_comm_xz                                      ! Plane communicators
    integer, public :: ims_comm_x, ims_comm_z                           ! Directional communicators
    integer, public :: ims_comm_xz_aux
    integer, public :: ims_comm_x_aux, ims_comm_z_aux

    integer, public :: ims_pro                                          ! Local PE number in global communicator
    integer, public :: ims_pro_i, ims_pro_j, ims_pro_k                  ! Local PE number in directional communicators
    integer, public :: ims_npro                                         ! Total number of PE
    integer, public :: ims_npro_i, ims_npro_j, ims_npro_k               ! Number of PEs in directional communicators
    integer, public :: ims_offset_i, ims_offset_j, ims_offset_k         ! Grid offsets

    integer, public :: TLAB_MPI_REAL_TYPE

    integer, public :: ims_err, ims_tag

    real(wp), public :: ims_time_min, ims_time_max, ims_time_trans      ! Profiling
    integer(wi), public :: ims_bcs_imax, ims_bcs_jmax

    public :: TLabMPI_Initialize
    public :: TLabMPI_PANIC
    public :: TLabMPI_TAGUPDT, TLabMPI_TAGRESET
