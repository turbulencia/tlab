  ...
  DO it = 1,itime_size
     ...
     CASE ( 1 )
        ...
        IF ( icalc_scal .EQ. 1 ) THEN
           ...
           IF ( buoyancy%TYPE .EQ. EQNS_BOD_QUADRATIC   .OR. buoyancy%TYPE .EQ. EQNS_BOD_BILINEAR    .OR. &
                imixture .EQ. MIXT_TYPE_AIRWATER        .OR. imixture .EQ. MIXT_TYPE_AIRWATER_LINEAR ) THEN
              dummy = C_1_R/froude
