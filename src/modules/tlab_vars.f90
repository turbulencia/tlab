...
! ###################################################################
! fields
    integer(wi) :: imax, jmax, kmax, isize_field    ! 3D fields sizes locally per processor
    integer(wi) :: inb_flow, inb_flow_array         ! # of prognostic and diagnostic 3d flow arrays
    integer(wi) :: inb_scal, inb_scal_array         ! # of prognostic and diagnostic 3d scal arrays
