...
SUBROUTINE IO_READ_ONE_FIELD(name, iheader, nx,ny,nz,nt, isize,params, a, wrk)
...
#include "dns_open_file.h"
  ...
  RETURN
END SUBROUTINE IO_READ_ONE_FIELD
...
SUBROUTINE IO_WRITE_ONE_FIELD(name, iheader, nx,ny,nz,nt, isize,params, a, wrk)
...
#include "dns_open_file.h"
  ...
  RETURN
END SUBROUTINE IO_WRITE_ONE_FIELD
