...
! sixth-order centered (alpha=1/3)
  a(3     ) = C_0_R
  b(3     ) =-c0136
  c(3     ) =-c1418       + lambda*c0103  *dx(2)
  d(3     ) = C_0_R       + lambda        *dx(3)
  e(3     ) = c1418       + lambda*c0103  *dx(4)
  f(3     ) = c0136
  g(3     ) = C_0_R
...
! sixth-order centered (alpha=1/3)
  a(imax-2) = C_0_R
  b(imax-2) =-c0136
  c(imax-2) =-c1418       + lambda*c0103  *dx(imax-3)
  d(imax-2) = C_0_R       + lambda        *dx(imax-2)
  e(imax-2) = c1418       + lambda*c0103  *dx(imax-1)
  f(imax-2) = c0136
  g(imax-2) = C_0_R
! fifth-order biased
  a(imax-1) = C_0_R
...
! -------------------------------------------------------------------
  IF      ( ibc .EQ. 1 ) THEN ! array B22R
    e(2     ) =-C_5_R /C_6_R  ! fifth-order biased
    e(2     ) = C_11_R/C_12_R
    f(imax  ) = C_1_R/C_6_R
