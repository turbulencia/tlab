...
#include "integers.h"
  ...
  TREAL, DIMENSION(*)                 :: y
  TREAL, DIMENSION(imax,jmax,2)       :: halo_field
  ...
  DO i=halo_start,halo_end
    ...
    !#######################################################################
      ...
      length_g_p(5)=particle_local_grid_posz - gridpoint(5) !legnth x between x(i) and p
  ...
  RETURN
END SUBROUTINE RHS_PARTICLE_GLOBAL_INTERPOLATION_HALO_2_1D
