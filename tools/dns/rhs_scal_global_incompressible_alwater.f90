...
!#
!# Alberto: Changed to include inietia and differnt difusion. In this case it will assume that the first scalar is the 
...
!#
!########################################################################
SUBROUTINE  RHS_SCAL_GLOBAL_INCOMPRESSIBLE_ALWATER&
...
! -----------------------------------------------------------------------
  ...
  RETURN
END SUBROUTINE RHS_SCAL_GLOBAL_INCOMPRESSIBLE_ALWATER
